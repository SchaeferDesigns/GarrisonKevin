...
export const prices: Price[] = [
  {
    ...
    note: 'Laminat, Vinyl und Klickböden inklusive Zuschnitt und Verlegung.',
  },
  {
    id: 'sockelleisten',
    label: 'Sockelleisten',
...
export const services: Service[] = [
  {
    ...
    icon: 'plank',
    intro:
      'Laminat, Vinyl und Klickböden werden millimetergenau eingemessen, zugeschnitten und verlegt. Vom Vorbereiten des Untergrunds bis zur letzten Abschlussleiste bleibt alles in einer Hand – Sie bekommen einen Raum, der fertig ist und nicht nachgearbeitet werden muss.',
    bullets: [
      'Laminat, Vinyl und Klickböden aller gängigen Systeme',
      'Untergrund prüfen, reinigen und vorbereiten',
      'Trittschalldämmung und Dampfsperre nach Herstellervorgabe verlegen',
      'Millimetergenauer Zuschnitt an Türzargen, Heizrohren und Nischen',
      'Ausbesserungen und Teilflächen statt kompletter Neuverlegung',
      'Besenreine Übergabe des fertigen Raums',
    ],
    priceId: 'verlegung',
    metaTitle: 'Bodenverlegung Aalen – Laminat & Vinyl verlegen lassen',
    metaDescription:
      'Laminat, Vinyl und Klickböden fachgerecht verlegen lassen in Aalen und Umgebung. Ab 18 €/m² Arbeitsleistung, kostenlose Besichtigung und schriftliches Angebot.',
  },
  {
    slug: 'sockelleisten',
    title: 'Sockelleisten',
...
/** Leistungen, die bewusst nicht angeboten werden – schafft Klarheit und spart beiden Seiten Zeit. */
export const notOffered = ['Fliesen', 'Parkett', 'Estrich', 'PVC', 'Linoleum', 'Teppich'];

export const importantNotes = [
  'Das Material stellt und bezahlt der Kunde – Sie kaufen genau den Boden, den Sie möchten.',
...
export const processSteps: Step[] = [
  ...
  },
  {
    ...
    text: 'Wir legen einen festen Termin. Ich arbeite die Fläche in einem Zug ab, decke ab und halte die Baustelle sauber.',
  },
  {
    title: 'Übergabe',
...
export const faqs: Faq[] = [
  {
    ...
    answer:
      'Die Arbeitsleistung beginnt bei 18 € pro Quadratmeter. Sockelleisten kosten ab 7 € pro laufendem Meter, Acryl- und Silikonfugen ab 6 € pro laufendem Meter. Das sind Richtwerte – der verbindliche Preis steht nach der Besichtigung im schriftlichen Angebot.',
  },
  {
    question: 'Ist das Material im Preis enthalten?',
    answer:
      'Nein. Material stellt und bezahlt der Kunde. Sie kaufen genau den Boden, die Leisten und die Dämmung, die Sie möchten – ich berechne ausschließlich die Arbeitsleistung. Das macht die Rechnung transparent und Sie zahlen keinen Aufschlag auf Material.',
  },
  {
    question: 'Welche Böden werden nicht verlegt?',
    answer:
      'Nicht im Angebot sind Fliesen, Parkett, Estrich, PVC, Linoleum und Teppich. Der Schwerpunkt liegt bewusst auf Laminat, Vinyl und Klickböden sowie auf Sockelleisten und Fugenarbeiten.',
  },
  {
    question: 'In welchem Gebiet sind Sie tätig?',
    answer:
      'In Aalen und Umgebung, in einem Radius von rund 20 Kilometern. Dazu gehören unter anderem Hüttlingen, Wasseralfingen, Oberkochen, Essingen, Abtsgmünd, Neuler, Westhausen, Lauchheim, Bopfingen, Heubach und Mögglingen.',
  },
  {
    question: 'Wie schnell ist ein Termin möglich?',
    answer:
      'Das hängt von der Auftragslage ab. Schreiben Sie mir kurz Ihren Wunschzeitraum – ich melde mich in der Regel innerhalb von 24 Stunden mit einer realistischen Einschätzung zurück.',
  },
  {
    question: 'Übernehmen Sie auch kleine Aufträge?',
    answer:
      'Ja. Aufträge unter 250 € werden nach Stunden abgerechnet: ab 40 € pro Stunde bei mindestens 1,5 Stunden. Auch einzelne Räume, Ausbesserungen oder Teilflächen sind kein Problem.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Nein. Es gilt die Kleinunternehmerregelung nach § 19 UStG, daher werden alle Preise ohne Umsatzsteuer ausgewiesen.',
  },
];
...
export const trustPoints = [
  {
    ...
    text: 'Sie sprechen mit der Person, die auch verlegt. Keine wechselnden Kolonnen, keine Übergabefehler.',
  },
  {
